    ...
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="text-gray-700 text-sm font-medium">Active Agents</div>
          <div className="text-3xl font-bold mt-2">12</div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="text-gray-700 text-sm font-medium">Workflows</div>
          <div className="text-3xl font-bold mt-2">8</div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="text-gray-700 text-sm font-medium">Executions Today</div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center py-2 border-b">
            <div>
              ...
              <div className="text-sm text-gray-700">15 minutes ago</div>
            </div>
